...
(function (RongIMLib) {
  var RongIMVoice = (function () {
    ...
    RongIMVoice.init = async function () {
      ...
      if (this.notSupportH5) {
        ...
        script.src =
          ...
          '//cdn.ronghub.com/swfobject-2.0.0.min.js';
        ...
        script.onload = function () {
          ...
          swfobject.embedSWF(
            ...
            '//cdn.ronghub.com/player-2.0.2.swf',
            'flashContent',
            '1',
            '1',
            swfVersionStr,
      ...
      // 按需动态加载js资源 写个小小的回调地狱
      // require('https://cdn.tellers.cn/glowe/web_amr_js/libamr-2.2.5.min.js').then((res) => {
      //   require('https://cdn.tellers.cn/glowe/web_amr_js/amr.js').then(() => {
      //     require('https://cdn.tellers.cn/glowe/web_amr_js/amr-wb.js');
      //   });
      // });

      const script0 = document.createElement('script');
      script0.type = 'text/javascript';
      script0.src = 'https://cdn.tellers.cn/glowe/web_amr_js/libamr-2.2.5.min.js';
      if (document.head.append) {
        document.head.append(script0);
      } else {
      ...
      script0.onload = function () {
        ...
        script1.src = 'https://cdn.tellers.cn/glowe/web_amr_js/amr.js';
        if (document.head.append) {
        ...
        script1.onload = function () {
          ...
          script2.src = 'https://cdn.tellers.cn/glowe/web_amr_js/amr-wb.js';
          if (document.head.append) {
    ...
    RongIMVoice.preLoaded = function (base64Data, callback) {
      ...
      if (false) {
        ...
        if (!me.notSupportH5) {
          ...
          (audio.play() || nopromise).catch(function () { }); //瑙ｅ喅娴忚鍣ㄦ姤閿� The play() request was interrupted by a new load request
    ...
    RongIMVoice.preLoadedPlay = function (voice) {
      if (voice) {
